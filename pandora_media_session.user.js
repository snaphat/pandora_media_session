...
(function () {
    ...
    // FF specific: Add small almost empty blank audio file (2 non-zero samples, 3 seconds long)
    ...
    function updateMetadata() {
        ...
        // FF specific: Check status of playback and correct media-session info.
        if (audio) {
